...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Vivakshaa</a></li>
      ...
      columns : [
            ...
            {data: 'actions', 'render': function (data, type, row) {
                        ...
                        if(data['authorizedToEdit']) {
                          options += '<a href="' + data['edit'] + '" title="Edit user?"><button class="btn btn-outline-info btn-xs mr-2">Edit</button></a> ';
                        }
